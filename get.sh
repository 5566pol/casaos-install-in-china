...
readonly CASA_UNINSTALL_URL="https://kkgithub.com/IceWhaleTech/get/main/uninstall.sh"
...
Check_Arch() {
    ...
    *)
    ...
    CASA_PACKAGES=(
        "https://kkgithub.com/IceWhaleTech/CasaOS-Gateway/releases/download/v0.3.6/linux-${TARGET_ARCH}-casaos-gateway-v0.3.6.tar.gz"
        "https://kkgithub.com/IceWhaleTech/CasaOS-UserService/releases/download/v0.3.6/linux-${TARGET_ARCH}-casaos-user-service-v0.3.6.tar.gz"
        "https://kkgithub.com/IceWhaleTech/CasaOS/releases/download/v0.3.6/linux-${TARGET_ARCH}-casaos-v0.3.6.tar.gz"
        "https://kkgithub.com/IceWhaleTech/CasaOS-UI/releases/download/v0.3.6/linux-all-casaos-v0.3.6.tar.gz"
    )
}
